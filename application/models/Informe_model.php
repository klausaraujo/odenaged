...
class Informe_model extends CI_Model
{
	...
	{
		$this->db->select('da.ideventotipodanio,da.idtipodanio,da.cantidad,td.tipo_danio');
        $this->db->from('evento_tipo_danio_preliminar da');
	...
	{
		$this->db->select('ap.idtipoaccionevento,ap.idtipoaccion,ap.descripcion,ap.fecha,ta.tipo_accion');
        $this->db->from('tipo_accion_evento_preliminar ap');
	...
	public function listaFotos()
	{
        ...
        $this->db->from('galeria_evento_preliminar');
